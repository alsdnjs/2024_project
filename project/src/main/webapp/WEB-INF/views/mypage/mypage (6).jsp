				...
				<div class="modal-body">
					...
					function openLikesModal() {
					    $.ajax({
					        ...
					        method: 'GET',
					        data: { user_idx: userIdx }, // userId 값을 전달
					        dataType : "json",
					                    ...
					                    modalBody.append(`
					                        <div class="col-xl-3 col-md-6 mb-3">
					                            <div class="product-card">
					                                <img src="${item.thumbnail_url}" class="product_img" alt="상품 이미지">
					...
					<!-- 
						...
						<c:otherwise>
								<c:forEach var="k" items="${llist}" varStatus="c">-->
									<!-- 상품 카드 -->
									<!--<div class="col-xl-3 col-md-6 mb-3">
										<div class="product-card">
