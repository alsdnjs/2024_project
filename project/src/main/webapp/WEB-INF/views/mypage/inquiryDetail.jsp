			...
			<div class="row">
				...
				<div class="mt-4" id="main-content">
					...
					<div class="inquiry-details">
						<h4>문의 제목: ${ivo.subject}</h4>
						<p>
							<strong>분류:</strong> ${ivo.category}
						</p>
						<p>
							<strong>작성일:</strong> ${ivo.write_date}
						</p>
						<p>
							<strong>제목:</strong> <a>${ivo.subject}</a>
						</p>
						<p>
							<strong>문의 내용:</strong> <a>${ivo.content}</a>
						</p>
						<p>
							<strong>파일 첨부:</strong>
						</p>
						<c:choose>
						<c:when test="${empty ivo.f_name}">
							<td><b>첨부파일 없음</b></td>
						</c:when>
						<c:otherwise>
							<td><a href="/inquiry_down?f_name=${ivo.f_name}">
								<img alt="" src="resources/upload/${ivo.f_name}" style="width: 250px"></a>
									<br>${ivo.f_name} </td>
						</c:otherwise>
					</c:choose>
						<p>${ivo.content}</p>
