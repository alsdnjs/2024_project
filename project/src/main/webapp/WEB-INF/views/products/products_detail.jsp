...
<body>
		...
		<nav class="navbar navbar-expand-lg ">
            <div class="container px-4 px-lg-5">
                ...
                <div class="search-container">
				    ...
				    <!-- 장바구니 리스트 -->
                    <form class="d-flex" action="/cart_list">
	...
	<div class="container px-4 px-lg-5">
		...
		<div class="row gx-4 gx-lg-5 align-items-center my-5">
			...
			<div class="col-lg-5">
				<h1 class="font-weight-light" style="margin-top: -30px;">${pvo.product_name} </h1>
				<p>신선한 상품</p>
				<p>배송 : 2일 후에 도착</p>
				<p>배송 후 : 교환 및 반품 불가</p>
				<p>신선배송 : 포장비 없음</p>

				<a class="btn btn-primary1 btn-spacing" href="/cart">장바구니 담기</a> 
				...
				<div class="col-xs-12">
					<nav>
						<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
							<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">상품설명</a> 
		
							<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false" onclick="loadReviews()">상품평</a>
							<a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false">유의사항</a>
						</div>
					</nav>
					<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
						...
						<div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
							...
							<p>• 저희 경빈이네는 전국 시,구에서 주문하신 상품은 냉동차량(신선물류)을 통해 신선함을 유지하여 배송
								...
								대량구매시 배송지가 제주도, 울릉군, 백령도인 경우 유선상으로 주문이 가능합니다.
							</p>
						</div>
					</div>
				</div>
