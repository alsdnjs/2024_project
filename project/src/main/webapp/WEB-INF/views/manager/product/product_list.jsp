		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="search-bar d-flex justify-content-between mb-4">
					...
					<a href="/product_write" class="btn btn-primary">상품 정보 등록하기</a>
				</div>

				<h3>상품 정보 보기</h3>
				<div class="register-link">
					<p>
						<a href="/product_list" class="btn-custom">정보 새로고침</a>
					</p>
				</div>
					...
					<tbody id="tbody">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<c:forEach items="${product_list}" var="k" varStatus="c">
									<tr>
										...
										<c:choose>
											...
											<c:otherwise>
												<c:choose>
													<c:when test="${k.is_active == 1}">
														<td>판매중</td>
													</c:when>
													<c:otherwise>
														<td style="color: blue;">비판매중</td>
													</c:otherwise>
												</c:choose>
											</c:otherwise>
										</c:choose>
										<td><a href="/product_detail?product_idx=${k.product_idx}"
				...
				<div class="d-flex justify-content-center">
					<c:if test="${currentPage > 1}">
						<a href="/product_list?page=${currentPage - 1}"
