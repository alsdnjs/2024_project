...
<div>
		...
		<form method="post" enctype="multipart/form-data"
			...
			<table>
				...
				<tr>
					<td>제재 사유</td>
					<td colspan="2">
						<textarea rows="10" cols="60" name="warn_cause" id="warn_cause" ></textarea>
					</td>
				</tr>
				...
				<tfoot>
					<tr align="center">
						<td colspan="5">
						<input type="submit" value="제재완료" onclick="warn_ok(this.form)">
	...
	<script type="text/javascript">
		...
		function warn_ok(form){
			if (confirm("정말 제재할까요?")) {
				form.action = "/user_warn_ok";
				form.submit();
			} else {
				alert("제재가 취소되었습니다.")
			}
