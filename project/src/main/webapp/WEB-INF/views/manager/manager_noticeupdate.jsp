...
<body>
	<div id="bbs">
	<form method="post" encType="multipart/form-data" action = "/adminnotice_update_ok">
			...
			<tbody>
				...
				<tr>
					...
					<c:choose>
						...
						<c:otherwise>
							<td>
								<input type="file" name="file_name"><b>이전 파일 있음<br>(nvo.f_name)</b>
								<input type="hidden" name="old_f_name" value="${nvo.f_name }">
								</td>
						</c:otherwise>
					</c:choose>
