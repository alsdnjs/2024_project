...
<div class="form-group">
    ...
    <div class="id_input_box">
        <input class="id_input" type="text" name="seller_rep_name" placeholder="대표자명을 입력하세요" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="id_input_box">
        <input class="id_input" type="tel" name="contact_number" placeholder="사업장 전화번호를 입력하세요" required>
    </div>
</div>
