...
<div class="wrapper">
    <form action="/find_password_change" method="post">
        <div class="subjecet">비밀번호 찾기</div>
        
        <label for="userId">아이디</label>
        <input type="text" id="userId" name="user_id" placeholder="아이디 입력" required>
        ...
        <input type="submit" class="find_button" value="비밀번호 찾기">
    </form>
</div>
