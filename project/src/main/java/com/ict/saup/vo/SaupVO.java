package com.ict.saup.vo;

public class SaupVO {
	private String sellers_id, store_name, store_description, create_at, update_at, contact_number, seller_rep_name, user_id ;

	public String getSellers_id() {
		return sellers_id;
	}

	public void setSellers_id(String sellers_id) {
