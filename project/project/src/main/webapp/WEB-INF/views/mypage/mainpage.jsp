...
.dropdown-menu {
  ...
  --bs-dropdown-header-color: rgb(255, 0, 0);
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel" style="width: 100%; height: 500px; background-color: LightCoral;">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../upload/aa.png" class="d-block w-100" alt="Slide 1" style="height: 500px; object-fit: contain;">
            </div>
            <div class="carousel-item">
                <img src="../upload/ee.png" class="d-block w-100" alt="Slide 2" style="height: 500px; object-fit: contain;">
            </div>
            <div class="carousel-item">
                <img src="../upload/tt.png" class="d-block w-100" alt="Slide 3" style="height: 500px; object-fit: contain;">
            </div>
        </div>
