...
<script type="text/javascript">
	function maskSellerRepName(seller_rep_name) {
		if (seller_rep_name && seller_rep_name.length >= 2) {
			return seller_rep_name.charAt(0) + "*" + seller_rep_name.substring(2);
		}
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="search-bar d-flex justify-content-between mb-4">
					<div class="search-container">
						<form action="/seller_search" method="get">
				...
				<div class="register-link">
					<p>
						<a href="/seller_list" class="btn-custom">정보 새로고침</a>
					</p>
				</div>
					...
					<tbody id="tbody">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<c:forEach items="${seller_list}" var="k" varStatus="c">
									<tr>
										...
										<td><script>
											document
													.write(maskSellerRepName('${k.seller_rep_name}'));
										</script></td>
										<td>${k.create_at}</td>
										<td><a href="/seller_detail?sellers_idx=${k.sellers_idx}"
				...
				<div class="d-flex justify-content-center">
					<c:if test="${currentPage > 1}">
						<a href="/seller_list?page=${currentPage - 1}"
