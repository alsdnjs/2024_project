package com.ict.mypage.seller.vo;

public class MypageSellerProfileVO {
	private String sellers_idx, store_name, store_description, create_at, update_at,
	contact_number, seller_rep_name, user_id, password;
